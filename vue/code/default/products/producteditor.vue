        ...
        methods: {
            ...
            SetData() {
                if (this.value) {
                    ...
                    this.EVRating = this.value.EVRating
...
<template>
    <divloading :fullpage="false" :loading="loading" class="mt-1">
        <form @submit.prevent="submit" class="d-flex flex-column">
            ...
            <formitem name="inputEVRating" label="Environmental Rating" v-model="EVRating" type="number"
                :customLayout="true">
                <vrating v-model="EVRating" icon_class="fab fa-envira" :editable="true" :display="true"
                    active_class="text-success" class="form-control justify-content-between"></vrating>
            </formitem>
