<script>
    export default {
        ...
        methods: {
            can_login() {
                if (isEmpty(this.username.trim()) || isEmpty(this.password.trim())) {
                    return false
                }
                return true
            },
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div dir="ltr">
                            <div id="marketing-reports" class="apex-charts" data-colors="#3bafda,#1abc9c,#f7b84b">
                            </div>
                        </div>
