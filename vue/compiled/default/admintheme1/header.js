                        ...
                        <div class="nav-wrap">
                            ...
                            <nav id="mainnav" class="mainnav">
                                <ul class="menu">
                                    ...
                                    <li class="has-mega-menu" v-if="pages.length > 2">
                                        ...
                                        <ul class="submenu submenu-right mega-menu clearfix">
                                            ...
                                            <li class="menu-column" v-if="pages.length > 6">
                                                <ul>
                                            ...
                                            <li class="menu-column" v-if="pages.length > 11">
                                                <ul>
                                            ...
                                            <li class="menu-column" v-if="pages.length > 16">
                                                <ul>
